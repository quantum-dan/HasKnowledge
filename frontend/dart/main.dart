...
main() async {
  Element buttonContainer = new DivElement()..classes.add("dartnavbar");
...
Future<Element> loginButton() async {
  ...
  Element authButton = new InputElement()
    ...
    ..onClick.listen(
        (_) => window.location.href = isLoggedIn ? logoutUrl : loginUrl);
  return authButton;
}
